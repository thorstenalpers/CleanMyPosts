...
Format: context → decision → consequences (good _and_ bad) → alternatives considered.
...
| [0003](0003-browser-extension-in-repo.md) | Browser extension in this repo, versioned separately | Accepted           |
