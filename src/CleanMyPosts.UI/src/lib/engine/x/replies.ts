...
async function findCaretWithRetry(article: Element, maxRetries = 5, delayMs = 200): Promise<HTMLElement | null> {
...
async function clickDeleteOnReply(userName: string, waitBetweenRetryDeleteAttempts: number): Promise<boolean> {
