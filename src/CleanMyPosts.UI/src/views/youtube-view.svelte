<script lang="ts">
  ...
  const groups: ActionGroupDef[] = [
    { key: 'comments', label: 'Comments', icon: MessageSquareIcon, showAction: 'showComments', deleteAction: 'deleteComments', plural: 'comments' },
    { key: 'likes', label: 'Likes', icon: HeartIcon, showAction: 'showLikes', deleteAction: 'deleteLikes', plural: 'liked videos' }
  ];
</script>
