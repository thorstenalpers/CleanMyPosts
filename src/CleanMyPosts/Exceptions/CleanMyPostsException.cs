...
/// </summary>
public class CleanMyPostsException : Exception
{
    /// <summary>
    ...
    /// <summary>
    ///     Initializes a new instance of the <see cref="CleanMyPostsException" /> class with a specified error message and a
    ///     reference to the inner exception that is the cause of this exception.
    /// </summary>
    /// <param name="message">The message that describes the error.</param>
    /// <param name="inner">The exception that is the cause of the current exception.</param>
    public CleanMyPostsException(string message, Exception inner)
        : base(message, inner)
    {
    }
}